...
public class ExisteGancheraActivity extends Activity {

    private Activity myActivity = this ;
    private static final String LOG_TAG = ExisteGancheraActivity.class.getSimpleName();
    ...
    class loadPoll extends AsyncTask<Void , Integer , Boolean> {
        ...
        protected void onPostExecute(Boolean result) {
            ...
            if (result){
                ...
                intent = new Intent(myActivity, StockActivity.class);
