...
import com.dataservicios.ttauditalicorphulk.Model.PresencePublicity;
...
import com.dataservicios.ttauditalicorphulk.adapter.PublicityAdapter;
import com.dataservicios.ttauditalicorphulk.app.AppController;
...
public class PresenciaMaterial extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getActionBar().setTitle("Visibilidad Alicorp Mayoristas");
       ...
       // adapter = new PublicityAdapter(this, db.getAllPublicity());
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                //Intent intent = new Intent("com.dataservicios.ttauditalicorphulk.DETAIPUBLICITY");
...
//                presencePubli = db.getAllPresencePublicityGroupCategory();
                ...
                argRuta.putInt("road_id", rout_id);
                Intent intent;

                intent = new Intent(MyActivity, ExisteGancheraActivity.class);
