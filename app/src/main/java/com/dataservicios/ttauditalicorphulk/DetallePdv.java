...
import com.dataservicios.ttauditalicorphulk.AditoriaAlicorp.ClienteProgramaActivity;
import com.dataservicios.ttauditalicorphulk.AditoriaAlicorp.PresenciaMaterial;
...
public class DetallePdv extends FragmentActivity {
    ...
    private int idPDV, rout_id, store_id,idCompany;
    ...
    Button btCerrarAudit,btGuardarLatLong; //, btEditStore; ,
                                            ...
                                            bt.setOnClickListener(new View.OnClickListener() {
                                                ...
                                                public void onClick(View v) {
                                                    ...
                                                    switch (idAuditoria) {
                                                        ...
                                                        case 50:
                                                            intent = new Intent(MyActivity, ClienteProgramaActivity.class);
                                                            intent.putExtras(argRuta);
                                                            startActivity(intent);
                                                            break;
